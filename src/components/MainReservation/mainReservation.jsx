        ...
        <div className="w-full max-w-[970px] bg-[#292E36]/80 px-[24px] sm:px-[50px] lg:px-[95px] py-[40px] sm:py-[70px] lg:py-[110px]">
          ...
          <form>
            ...
            <div className="flex justify-center mt-8 lg:mt-12">
              <button className="w-full sm:w-[250px] h-[56px] sm:h-[64px] lg:h-[68px] bg-white text-[#292E36] text-[16px] lg:text-[22px] font-['Josefin_Sans'] hover:bg-[#E1B168] hover:text-white duration-300">
                Book A Table
              </button>
            </div>
          </form>
